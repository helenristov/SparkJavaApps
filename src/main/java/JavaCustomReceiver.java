...
//object JavaCustomReceiver extends Receiver<String> {
...
*/
  ...
  private void receive() {
    try {
	  ...
	  String filename = "./data/MDR_Test_Receiver.txt";
      try {
		...
		// Replacing the SocketReader with a FileReader for testing.
